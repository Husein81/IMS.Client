...
import { useCreateCustomerMutation, useGetCustomerQuery, useUpdateCustomerMutation } from "../../app/redux/Slice/customerApi";
...
const CustomerForm: React.FC<Props> = ({ id, refetch }) => {
    ...
    const {data: customer, refetch:refetchById} = useGetCustomerQuery(id!, {skip: !id});
