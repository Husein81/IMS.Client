  ...
  return (
    <Paper elevation={3} sx={{bgcolor:colors.white[500], my:1}}>
        <Box p={2} > 
            ...
            <Box display={'flex'} gap={2} py={1} justifyContent={'space-between'} alignItems={'center'}>
                <Box>
                    <IconButton
                ...
                <Box>
                    <Button  variant="outlined" sx={{cursor:'pointer', color:colors.black[500]}} onClick={() => navigate('/customers')}>
                        View Customers
                    </Button>
                </Box>
            </Box>
